...
function receiveChatText() {
	...
	if (httpReceiveChat.readyState == 4 || httpReceiveChat.readyState == 0) {
		httpReceiveChat.open("GET", GetChaturl + "&sac_lastID=" + sac_lastID + "&nonce=240bbccdfe" + "&rand=" + Math.floor(Math.random() * 1000000), true);
...
function checkName() {
	...
	if (chat_name != sacCookie) {
		document.cookie = "sacUserName="+ chat_name +"; expires=Mon, 30 Oct 2017 16:43:23 UTC;"
	}
...
function checkUrl() {
	...
	if (currentName.value != sacCookie) {
		document.cookie = "sacUrl="+currentName.value+"; expires=Mon, 30 Oct 2017 16:43:23 UTC;"
		return;
	}
